...
<div class="fixed inset-0 bg-black grid {gridClasses} gap-0.5 h-dvh w-full overflow-auto">
	{#each selectedStreams as stream}
		<div class="relative bg-neutral-900 aspect-video sm:aspect-auto sm:h-full">
			<div class="absolute inset-0 flex items-center justify-center text-neutral-500 text-sm p-2 text-center">
				{stream}
			</div>
